...
public:
        ...
        _pin(pin)
    {
        ...
        memset(_pixelsEditing, 0x00, _pixelsSize); //DJ-Original code
        std::memset(_pixelsEditing, 0x00, _pixelsSize); //DJ-Added std:: before memset
